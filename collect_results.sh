...
cat result7_1.log | python ../hyfd_log_analyzer.py | python3 ../8line.py result3.json result7_1.json result5_2.json result6_1.json r bfhd_runtime_over_r || echo "Didn't create bfhd_runtime_over_r"
echo | python3 ../8line.py result8_3.json result8_2.json result10_3.json result9_1.json c jlnp_runtime_over_c || echo "Didn't create jlnp_runtime_over_c"
